...
void CMainFrame::CreatePaneWindow(CDockablePane& pane, const TCHAR* title, DWORD id)
{
	...
	BOOL bRet = pane.CreateEx(NULL, title, this, CRect(0, 0, 100, 100), TRUE, id, dwStyle);
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CreatePaneWindow(m_FieldGenPane, L"FieldGenPane", 0001);
	m_TabbedPane.AddTab(&m_FieldGenPane);
